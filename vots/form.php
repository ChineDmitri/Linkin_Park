...
<div align="center"><a href="<?print$p_path;?>add.php?name=<?print$pollname;?>&w=<?print$p_rwidth;?>&coltype=<?print$p_coltype;?>" target="_blank" title="Посмотреть результаты опроса">Результаты</a>
</form>
</td></tr></table>
</td></tr></table>
<?
