...
if($QUERY_STRING==""){ $QUERY_STRING = $HTTP_SERVER_VARS["QUERY_STRING"];}     //Устранение бага [RedCat]
$a7f89abdcf9324b3 = "";

///////////////////////////////////////////////////////
// Функция:         formatsize
// Описание: Форматирование размера файла
...
// Description: Форматирование строки запроса для index.php?
...
////////////////////////////////////////////////////////
// Function:         echoheader
// Description: отображение заголовка скина
...
////////////////////////////////////////////////////////
// Function:         echofooter
// Description: отображение низа скина
...
function echofooter(){
    ...
    $skin_footer = preg_replace("/{copyrights}/", "<div style='font-size: 9px'>Powered by <a style='font-size: 9px' href=\"http://cutephp.com/cutenews/\" target=_blank>$config_version_name</a> © 2004  <a style='font-size: 9px' href=\"http://cutephp.com/\" target=_blank>CutePHP</a>.<br>Перевод на русский <a style='font-size: 9px' href=\"http://x-coders.net/\" target=_blank>X-Coders Team</a></div>", $skin_footer);
...
////////////////////////////////////////////////////////
// Function:         b64dck
// Description: Wanna Cheat huh :| ?  //Чёто не понятное
function b64dck(){
...
// Description: Кол-во комментариев в статье
...
// Description: Замена символов в комментарии
...
////////////////////////////////////////////////////////
// Function:         get_skin
// Description: Получить скин!

function get_skin($skin){
        $msn = bd_config('c2tpbg==');
    $cr = bd_config('e2NvcHlyaWdodHN9');
    $lct = bd_config('');
    //$skin = preg_replace("/$cr/", "<div style='font-size: 9px'>Powered by! <a style='font-size: 9px' href=\"http://cutephp.com/cutenews/\" target=_blank>$config_version_name</a> © 2004  <a style='font-size: 9px' href=\"http://cutephp.com/\" target=_blank>CutePHP</a>.</div>", $skin_footer);
    $lct = $lct."<div style='font-size: 9px'>Перевод на русский <a style='font-size: 9px' href=\"http://x-coders.net/\" target=_blank>X-Coders Team</a></div>";
...
// Description: Замена символов в новостях
