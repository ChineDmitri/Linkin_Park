...
$skin_menu = <<<HTML
    ...
    <td>
        <a class="nav" href="$PHP_SELF?mod=main">Начало</a>
                ...
                <td>|</td>
                <td>
        <a class="nav" href="$PHP_SELF?mod=addnews&action=addnews" accesskey="a">Добавить новости</a>
                </td>
                <td>|</td>
                <td>
        <a class="nav" href="$PHP_SELF?mod=editnews&action=list">Редактировать новости</a>
                </td>
                <td>|</td>
                <td>
