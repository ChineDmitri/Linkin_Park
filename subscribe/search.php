...
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="100%" align="right">От даты
...
echo<<<HTML
  ...
  <tr>
    <td width="100%" align="right">До даты
...
echo<<<HTML
  ...
  <tr>
    ...
    <tr>
      <td>
        <p align="right">&nbsp;
    <a href="javascript:ShowOrHide('advanced','')">Дополнительно</a>&nbsp;&nbsp; <input type=submit value=Искать>
      </td>
    </tr>
  </table>
</div>
...
if($dosearch == "yes")
{
	...
	if($search_in_archives){
    	if(!$handle = opendir("$cutepath/data/archives")){ die("<center>Не возможно открыть папку $cutepath/data/archives "); }
	...
	echo"<br /><b>Найденые материалы [". count($found_arr)."]:</b><br />";
