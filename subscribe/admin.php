<? // WR-Subscribe v 1.1 // 06.08.06 г. // Miha-ingener@yandex.ru
...
$shapka="<html><head>
<title>Рассылка WR-Subscribe 1.0</title>
...
<form action='$sburl' method='get' target='WRSub' name=REPLIER>Подпишитесь на новости нашего сайта! Рассылка еженедельная.<BR>
...
<tr><td>Название рассылки (тема в письме)</td><td><input type=text value='$sbname' name=sbname size=55></tr></td>
<tr><td>Заголовок рассылки</td><td><textarea rows=6 cols=50 name=top>$top</textarea></tr></td>
<tr><td>Подпись в рассылке</td><td><textarea rows=6 cols=50 name=bottom>$bottom</textarea></tr></td>

<tr><td>Скольки подписчикам отправлять пиьма за этап?</td><td><input type=text value='$step' name=step size=10 maxlength=2> Рекомендуемое значение 10-30 человек / этап</tr></td>
...
<tr><td>Разрешить / приостановить подписку на рассылку </td><td><input type=radio name=status value=\"1\"$m1> разрешить&nbsp; <input type=radio name=status value=\"0\"$m2> приостановить</tr></td>
...
$configdata="<? // WR-Subscribe v 1.1 // 23.04.06 г. // Miha-ingener@yandex.ru\r\r\n".
