...
// ********************************************************************************
$skin_menu = <<<HTML
<a class="nav" href="$PHP_SELF?mod=main">Начало</a>
</td>
<td>|</td>
<td>
<a class="nav" href="$PHP_SELF?mod=addnews&action=addnews" accesskey="a">Добавить новость</a>
</td>
<td>|</td>
<td>
<a class="nav" href="$PHP_SELF?mod=editnews&action=list">Редактировать новость</a>
</td>
<td>|</td>
<td>
<a class="nav" href="$PHP_SELF?mod=options&action=options">Настройки</a>
</td>
<td>|</td>
<td>
<a class="nav" href="$PHP_SELF?mod=about&action=about">Помощь</a>
</td>
<td>|</td>
<td>
<a class="nav" href="$PHP_SELF?action=logout">Выход</a>
HTML;
// ***********
// Skin HEADER
// ***********
